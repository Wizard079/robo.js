...
```bash
npx robo add /path/to/cron
```

Replace `/path/to/cron` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `robo build` command.
